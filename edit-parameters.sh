...
# Purpose: Make it easier to edit the correct driver parameters file.
#
# Flexible editor support.
#
# To make this file executable:
#
# $ chmod +x edit-parameters.sh
#
...
SCRIPT_NAME="edit-parameters.sh"
# SCRIPT_VERSION="20260507"
...
printf "Do you want to apply the new parameters by rebooting now? (recommended) [Y/n] "
read -r yn
case "$yn" in
	[nN]) ;;
	*) reboot ;;
